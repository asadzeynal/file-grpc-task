...
const (
	FileService_Upload_FullMethodName   = "/proto.file.v1.FileService/Upload"
	FileService_LS_FullMethodName       = "/proto.file.v1.FileService/LS"
	FileService_Download_FullMethodName = "/proto.file.v1.FileService/Download"
)
...
func (c *fileServiceClient) LS(ctx context.Context, in *LSRequest, opts ...grpc.CallOption) (*LSResponse, error) {
	out := new(LSResponse)
	err := c.cc.Invoke(ctx, FileService_LS_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedFileServiceServer) LS(context.Context, *LSRequest) (*LSResponse, error) {
...
func _FileService_LS_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FileService_LS_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var FileService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "proto.file.v1.FileService",
